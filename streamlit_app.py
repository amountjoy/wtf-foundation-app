...
def page_geometry_optimisation():
    ...
    if st.session_state.get("load_data") and st.session_state.get("mat_props"):
        with st.form("optimisation_form"):
            ...
            h1_h2_thk_tol = st.number_input("Thickness Tolerance (±)", value=2)
